...
def main():
    ...
    for d in all_dates:
        ...
        if (not force_rebuild) and SKIP_IF_EXISTS and os.path.exists(out_daily):
            ...
            html_daily, _bundle = bu남성 ROC 라이트 5 포켓 팬츠

ROC Lite 5 Pocket

C72AE0937397

쿨링과 발수 기능이 있는 일상 아웃도어 겸용 롱 팬츠

가볍지만 강력한 퍼포먼스를 자랑하는 치노 팬츠를 만나보세요.
신축성 있는 나일론 원단이 움직임에 따라 자연스럽게 늘어나 활동성을 극대화하며,
편안한 허리밴드가 하루 종일 안정적인 착용감을 선사합니다.

- OMNI FREEZE 냉감성 경량 소재로 시원하고 가벼운 착용감 제공
- OMNI SHIELD 발수 기능으로 생활 방수 및 오염 방지
- 벨트 루프 적용으로 다양한 스타일 연출 가능
- 리플렉티브 디테일로 야간 활동 시 가시성 강화
- 러그드 아웃도어 컬렉션의 라이프스타일 ROC 팬츠 시리즈


남성 비치 스파이얼 릿지 IV 팬츠

Beach Spire Ridge IV Pant

C72XE5829010

아웃도어 활동에 최적화된 자외선 차단과 발수 기능이 있는 여름용 경량 스트레치 롱팬츠

하이킹 및 다양한 아웃도어 활동에 착용하기 좋은 베이직 경량 팬츠입니다.
신축성이 우수한 허리밴드가 적용되어 활동 시 편안한 착용감을 제공하며,
가벼운 나일론-스판 소재로 장시간 착용에도 부담이 적습니다.

기본 지퍼 포켓과 백 지퍼 포켓을 포함한 4-포켓 구조로 실용성을 강화했으며,
탈착 가능한 허리 벨트로 스타일과 기능성을 동시에 제공합니다.

Omni-Shade UPF 50 기술은 촘촘한 원단 구조와 특수 섬유로 UVA UVB 차단 효과를 제공해,
햇빛 아래에서도 안전하게 착용할 수 있습니다.

Omni-Shield 기술은 습기와 얼룩을 방지해 액체가 원단에 스며들지 않도록 하며,
빠르게 건조되는 소재 덕분에 습하고 지저분한 환경에서도 깨끗하고 건조하게 유지할 수 있습니다.

- 신축성 있는 허리밴드로 편안한 착용감 제공
- 경량 스트레치 나일론 소재로 가벼운 착용감과 내구성 강화
- Omni-Shade UPF50 : 자외선 차단 기능
- Omni-Shield : 발수 기능 습기와 오염에 강함
- 기본 지퍼 포켓 및 백 지퍼 포켓 포함
- 탈착 가능한 허리 벨트로 스타일과 기능성 강화

남성 잉글리쉬 하이크 OFZ ICE 셋업 스트레이트 팬츠

M's English Hike OFZ ICE Set Up Straight Pants

C72YM8627305

아웃도어 뿐만 아니라 일상에서도 입을 수 있는 기본에 충실한 풀이밴드 스타일의 셋업 팬츠 입니다.

- 소재가 가볍고 스트레치가 좋아 여름 시즌에 쉽게 착용 가능
- 신축성이 뛰어나며, 옴니프리즈제로 아이스 냉감 기능성 소재를 사용하여 피부에 닿는 순간 시원함을 전달해주고, 땀을 빠르게 건조시켜 활동성을 강화하고 장시간 착용에도 쾌적함 유지
- 나일론 혼방 소재로 구김이 잘 가지 않아 관리가 용이
- 뒤쪽과 양쪽 사이드 포켓으로 간단한 소지품 수납 가능
- 허벅지부터 밑단까지 일자로 떨어지는 기본적인 핏으로 깔끔한 실루엣 연출
- YM3627과 셋업 아이템으로 함께 착용 가능


남성 365 마운틴 팬츠

M’s 365 Mountain II Pants

C71YM8592053

365 스타일링에 최적화된 프리미엄 하이테크 컬렉션
그 어떤 환경이든 당신이 자연을 필요로 할 때 계획없이, 부담없이, 걱정없이 떠날 수 있는 HIKE 365 컬렉션을 소개합니다.
자연에서 영감을 받은 컬러웨이와 트렌디한 릴렉스 핏이 특징 입니다.

봄/가을 착용할 수 있는 내장 조디악 벨트가 있는 세미루즈핏 형태의 스트레치 팬츠 입니다.

- 플랫 카고포켓 적용되어 깔끔한 디자인
- 스트레치가 우수한 OMNI-SHIELD 원단 사용
- 바지 밑단 스트링 적용. 해당 스트링으로 바지를 돌돌말아 패커블 가능
- 허리밴드 하단 추가 고리 적용 : 스카프, 수건 등 다양한 소지품을 간편하게 걸어둘 수 있어 활동 시 더욱 편리


남성 랜드로머 스카우트 팬츠

Landroamer Scout Pant

C71AM8728271

자외선 차단과 발수 기능이 있는 일상용으로 활용 가능한 롱팬츠

이 팬츠는 릴렉스한 핏으로 편안한 캐주얼룩을 연출할 수 있으며,
신축성이 우수한 립스탑 소재를 사용해 활동성을 강화했습니다.

사이드심 히든 지퍼 포켓이 적용되어 실용성을 높였으며,
허리와 밑단에 조임 조절이 가능한 스트링을 더해 맞춤형 핏을 완성할 수 있습니다.
같은 시리즈의 랜드로머 오버셔츠(AM4935)와 함께 셋업으로 착용하면
스타일과 기능성을 동시에 갖춘 코디가 가능합니다.

- 릴렉스 핏으로 편안한 캐주얼룩 연출
- 신축성 좋은 립스탑 소재로 활동성 강화
- Omni-Shade Broad Spectrum UPF50 : 자외선 차단 기능
- Omni-Shield : 발수 기능으로 생활 방수 지원
- 사이드심 히든 지퍼 포켓으로 실용성 강화
- 허리/밑단 스트링으로 맞춤형 핏 조절 가능
- 랜드로머 오버셔츠와 셋업 코디 가능
...
- 허리/밑단 스트링으로 맞춤형 핏 조절 가능
- 랜드로머 오버셔츠와 셋업 코디 가능
ild_one(client, end_date=d, mode="daily", image_map=image_map, logo_b64=logo_b64)

...
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:radial-gradient(circle at 12% 18%, rgba(59,130,246,.10), transparent 28%),radial-gradient(circle at 84% 14%, rgba(34,197,94,.08), transparent 24%),radial-gradient(circle at 72% 74%, rgba(249,115,22,.08), transparent 24%),linear-gradient(180deg,#f8fbff 0%,#eef4fb 52%,#e8eff8 100%);background-size:120% 120%;animation:ambientShift 18s ease-in-out infinite alternate;color:var(--ink);font-family:'Pretendard','Noto Sans KR','Apple SD Gothic Neo','Malgun Gothic',Arial,sans-serif}.page{max-width:1600px;margin:0 auto;padding:34px 22px 96px}
.hero{position:relative;overflow:hidden;background:linear-gradient(180deg,#020617 0%,#030a1f 100%);border:1px solid rgba(15,23,42,.10);border-radius:28px;padding:26px 22px 14px;color:#fff;box-shadow:0 12px 30px rgba(2,6,23,.16)}.hero:before{content:'';position:absolute;inset:auto -80px -110px auto;width:320px;height:320px;border-radius:999px;background:radial-gradient(circle,rgba(255,255,255,.22),transparent 64%)}.hero:after{content:'';position:absolute;inset:-120px auto auto -110px;width:280px;height:280px;border-radius:999px;background:radial-gradient(circle,rgba(255,255,255,.12),transparent 68%)}
.hero-grid{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1.42fr) minmax(460px,.96fr);gap:52px;align-items:stretch}.eyebrow{display:inline-flex;align-items:center;gap:8px;padding:6px 11px;border:1px solid rgba(255,255,255,.14);border-radius:999px;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.14em;background:rgba(255,255,255,.06);backdrop-filter:blur(8px)}h1{margin:14px 0 8px;font-size:38px;line-height:1.02;letter-spacing:-.045em;font-weight:900}.hero p{max-width:760px;margin:0 0 14px;font-size:12px;font-weight:800;line-height:1.75;opacity:.92}.hero-meta{display:flex;gap:10px;flex-wrap:wrap}.period-chip{display:inline-flex;align-items:center;justify-content:center;min-width:72px;height:34px;padding:0 14px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.04);color:#fff;text-decoration:none;font-size:11px;font-weight:900;backdrop-filter:blur(8px);transition:.18s ease}.period-chip:hover{transform:translateY(-1px);background:rgba(255,255,255,.10)}.period-chip.active{background:#fff;color:#0f172a;border-color:#fff;box-shadow:none}
.hero-kpis{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:34px}.hero-stat,.card,.summary-card{background:rgba(255,255,255,.96);border:1px solid var(--line);border-radius:26px;box-shadow:var(--shadow-soft)}.hero-stat{position:relative;padding:28px 30px;color:var(--ink);min-height:148px;display:flex;flex-direction:column;justify-content:center}.hero-stat:before{display:none}.label,.kicker{font-size:10px;font-weight:900;letter-spacing:.16em;text-transform:uppercase;color:#94a3b8}.value,.kpi{margin-top:8px;font-size:18px;font-weight:900;line-height:1.05;word-break:break-word;letter-spacing:-.03em}
.toolbar{display:flex;justify-content:space-between;align-items:center;gap:28px;margin:36px 0 30px}.tabs,.subtabs{display:flex;gap:10px;flex-wrap:wrap}.tab-btn,.subtab-btn,.table-expand-btn{height:32px;padding:0 14px;border-radius:12px;border:1px solid #e5e7eb;background:#ffffff;color:#475569;font-weight:900;cursor:pointer;box-shadow:none;transition:.18s ease;font-size:11px}.tab-btn:hover,.subtab-btn:hover,.table-expand-btn:hover{transform:none;border-color:#cbd5e1}.tab-btn.active,.subtab-btn.active{background:#2563eb;color:#fff;border-color:#2563eb;box-shadow:none}
...
.chart-row{display:grid;grid-template-columns:92px 1fr 60px;gap:10px;align-items:center;margin:12px 0}.chart-label,.chart-metric{font-size:12px;font-weight:900}.chart-track{height:10px;background:#e6edf9;border-radius:999px;overflow:hidden}.chart-fill{display:block;height:100%;background:linear-gradient(90deg,#2451e6,#92b7ff);border-radius:999px}.nonbuyer-grid{gap:32px!important}
...
.table-meta,.table-tools{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;font-size:12px;font-weight:800;color:var(--muted)}.table-wrap{overflow:auto;border:1px solid var(--line);border-radius:24px;background:#fff;box-shadow:0 18px 32px rgba(15,23,42,.06)}.data-table{width:100%;min-width:860px;border-collapse:collapse}th,td{padding:10px 10px;border-bottom:1px solid #eef2f7;text-align:left;font-size:11px;font-weight:800;white-space:nowrap}th{background:#f8fbff;color:#64748b;text-transform:uppercase;letter-spacing:.08em;font-size:10px;position:sticky;top:0}td.num,th.num{text-align:right}.is-hidden{display:none}
.channel-panel{animation:fadeInUp .24s ease}.channel-panel[hidden]{display:none!important}@keyframes ambientShift{0%{background-position:0% 50%}100%{background-position:100% 50%}}@keyframes fadeInUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.hero,.summary-card,.card,.table-wrap{animation:fadeInUp .22s ease}

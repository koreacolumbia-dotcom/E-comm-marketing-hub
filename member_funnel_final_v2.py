...
.hero-grid{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1.42fr) minmax(500px,.96fr);gap:64px;align-items:stretch}.eyebrow{display:inline-flex;align-items:center;gap:8px;padding:9px 14px;border:1px solid rgba(255,255,255,.26);border-radius:999px;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.14em;background:rgba(255,255,255,.10);backdrop-filter:blur(10px)}h1{margin:18px 0 12px;font-size:64px;line-height:.98;letter-spacing:-.045em;font-weight:900}.hero p{max-width:900px;margin:0 0 24px;font-size:16px;font-weight:800;line-height:1.78;opacity:.97}.hero-meta{display:flex;gap:10px;flex-wrap:wrap}.period-chip{display:inline-flex;align-items:center;justify-content:center;min-width:78px;height:44px;padding:0 18px;border-radius:999px;border:1px solid rgba(255,255,255,.22);background:rgba(255,255,255,.06);color:#fff;text-decoration:none;font-size:14px;font-weight:900;backdrop-filter:blur(8px);transition:.18s ease}.period-chip:hover{transform:translateY(-1px);background:rgba(255,255,255,.12)}.period-chip.active{background:#fff;color:var(--navy);border-color:#fff;box-shadow:0 10px 24px rgba(8,19,58,.16)}
.hero-kpis{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:40px}.hero-stat,.card,.summary-card{background:rgba(255,255,255,.96);border:1px solid var(--line);border-radius:26px;box-shadow:var(--shadow-soft)}.hero-stat{position:relative;padding:32px 34px;color:var(--ink);min-height:164px;display:flex;flex-direction:column;justify-content:center}.hero-stat:before{content:'';position:absolute;left:0;top:18px;bottom:18px;width:4px;border-radius:999px;background:linear-gradient(180deg,var(--blue) 0%,#8eb4ff 100%)}.label,.kicker{font-size:11px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;color:var(--muted)}.value,.kpi{margin-top:10px;font-size:28px;font-weight:1000;line-height:1.08;word-break:break-word;letter-spacing:-.03em}
.toolbar{display:flex;justify-content:space-between;align-items:center;gap:34px;margin:44px 0 36px}.tabs,.subtabs{display:flex;gap:10px;flex-wrap:wrap}.tab-btn,.subtab-btn,.table-expand-btn{height:44px;padding:0 18px;border-radius:999px;border:1px solid var(--line);background:rgba(255,255,255,.9);color:var(--navy);font-weight:900;cursor:pointer;box-shadow:0 8px 20px rgba(15,23,42,.05);transition:.18s ease}.tab-btn:hover,.subtab-btn:hover,.table-expand-btn:hover{transform:translateY(-1px);border-color:var(--line-strong)}.tab-btn.active,.subtab-btn.active{background:linear-gradient(135deg,#102a74 0%,#1a43bc 100%);color:#fff;border-color:transparent;box-shadow:0 14px 30px rgba(31,67,183,.22)}
.summary-card{padding:38px 42px;margin-bottom:48px;background:linear-gradient(180deg,rgba(255,255,255,.98) 0%,rgba(247,250,255,.98) 100%)}.summary-card ul{margin:8px 0 0 16px;padding:0}.summary-card li{margin:10px 0;font-weight:800}
.panel{display:none}.panel.active{display:block}.section-head{display:flex;justify-content:space-between;align-items:flex-end;gap:34px;margin:52px 0 36px}.section-title{font-size:12px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;color:#697a98}.section-head h2{margin:6px 0 0;font-size:24px;line-height:1.2;letter-spacing:-.02em}
...
.grid-4{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:48px}.grid-3{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:48px}.grid-2{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:48px}.card{padding:42px;min-height:198px;background:linear-gradient(180deg,#fff 0%,#fbfdff 100%)}.kpi-sub{margin-top:8px;font-size:12px;font-weight:800;color:var(--muted)}
